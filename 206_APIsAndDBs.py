...
#joined_data = []
#tuples=cur.execute("SELECT Users.screen_name, Tweets.text FROM Users INNER JOIN Tweets on Users.user_id= Tweets.user_posted")
#for tup in tuples:
...
#joined_data2 = []
#tuples2=cur.execute("SELECT Users.screen_name, Tweets.text FROM Users INNER JOIN Tweets on Users.user_id= Tweets.user_posted ORDER BY Tweets.retweets")
#for tup in tuples2:
